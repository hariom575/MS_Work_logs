...
\begin{enumerate}
  ...
  \begin{enumerate}
      \item Calculate & plot weekly average time usage per app.
       \item Calculate & plot weekly access count per app.
...
\hline
Family Income Range & Diverse economic backgrounds; most respondents fall below \(\₹5,00,000\) annual family income \\
\hline
...
\begin{figure}[H]
   ...
   % \includegraphics[width=0.45\l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inewidth]{JoDo new UI design/dashboard.png}
