...
\subsubsectio{Qualitative Themes}
...
The pilot study confirmed that the core JoDo mechanisms — usage warnings, the launcher-as-friction model, and competitive leaderboards — produce measurable awareness and self-reported behaviour change even in a small three-participant cohort. The primary actionable feedback was the need for a modern, consistent UI (addressed in \S3) and improved unlock-detection accuracy (pending).
\
