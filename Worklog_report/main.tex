...
\begin{enumerate}
    ...
    \item Shared command volume btw certbot and Nginx.
    ...
    \item Added settings button on the homescreen clicking on it will ask permission for:  \textbf{Pause app activity when unused.}
\end{enumerate}
\subsection{To Do}
\begin{enumerate}
    \item Complete the testing and create the .aab file and send it for deployment.
\end{enumerate}
