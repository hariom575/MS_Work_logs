...
\begin{enumerate}
    ...
    \item In Django admin show data for every day for every user in single row for all the four sessions of the day, currently we are storing data in session wise formate for every date it is wasting space as well as create confusions while interpreting the data.
