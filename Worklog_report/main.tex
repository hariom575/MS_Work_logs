...
\section{Mar 09 2026 (last meeting) - Mar 12 2026}
{\bf No. of Hours: 10}
\subsection{To Do}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item If our project relies on guaranteeing the number of requests during concurrent requests, you will need to implement your own throttle class.
\end{enumerate}
\clearpage
