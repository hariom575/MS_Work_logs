...
\end{enumerate}
\section{May 18 2026 - May 24 2026}
{\bf No. of Hours 10}
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item They conducted user study with 25 participants mostly were university students over the period of 4 months.
    ...
    \item Participants over underestimate productivity and social and while overestimating entertainment app use. They showed a 10 \% improvement in postive effects ratting \textit{WellScreen} as \textbf{Moderately useful}.
    ...
    \begin{enumerate}
        \item \textit{The main of their was to examine how the recognizance of, and regular self-regulation on, college student's  estimated-actual gap in smartphone usage habits could advance our understanding of digital self-awareness and digital well-being.}
    \end{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{paper_11_demographic.png}
        \caption{Demographic information}
        \label{fig:placeholder}
    \end{figure}
    \item \textbf{Individual Self-reported differences}
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{paper_11_individual_self_reported_differences.png}
        \caption{Indivial self reported differences with range, mean(U) and variance (sigma)}
        \label{fig:placeholder}
    \end{figure}
    \item \textbf{Results}
    \begin{enumerate}
        \item \textbf{Linking Estimated-Actual gaps with daily well-being: }
\begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{result1.png}
        \caption{Linking Estimated-Actual gaps with daily well-being.}
        \label{fig:placeholder}
    \end{figure}
       \item \textbf{SoD E–A Gap: Linear mixed effects regression models revealing the relationship between individual differences with
SoD estimation–actual (E-A) gap} 
        \begin{figure}[H]
            \centering
    \includegraphics[width=1\linewidth]{result2.png}
            ...
            \label{fig:placeholder}
        \end{figure}
        \item Daily Wellbeing: Linear mixed effects regression models revealing the relationship between individual differences
and daily self-awareness of app usage with daily self-reports of feeling satisfied, difficulty, self-control, focused, and stressed;
   \begin{figure}
       \centering
     \includegraphics[width=1\linewidth]{result3.png}
       \caption{Enter Caption}
       \label{fig:placeholder}
   \end{figure}
   \item    
    \begin{figure}[H]
            \centering
            \includegraphics[width=1\linewidth]{result4.png}
            % \caption{Enter Caption}
            \label{fig:placeholder}
        \end{figure}
        \end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{result6.png}
    % \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
\item \textbf{Psychological Effects of Using WellScreen(participants response): } \textit{I feel like I’m more self-aware now, which is bet-
ter because I didn’t realize how much I was actually
spending on some applications. . . and that really is
helping me kind of structure what I do in a day.}
\item A two-dimensional representation showing distribution of participants by self-control (above vs. below median) and
SUS usability scores (above vs. below median). The figure also shows example responses to the question “Would you like to use
this tool in the future?” (Yes/No/Maybe), along with example responses in each quadrant.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{result7.png}
    \caption{Self-control vs SUS score}
    \label{fig:placeholder}
\end{figure}
\end{enumerate}[]
\subsection{Positive Points}
