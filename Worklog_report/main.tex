...
\begin{enumerate}
    \item Their core finding is that people are very bad at estimating their own phone use - but in interesting, category-specific ways rather than uniformally under or over-estimating.
    \item \textbf{What the Number shows?: }
    \begin{enumerate}
        \item \textbf{Social Media} was underestimated by {~9.6\%}. People used it more than they thought. Which is very natural by design of social media.
        ...
        \item \textbf{The Paradox (Table 6) :} smaller gaps (more accurate estimators) report higher satisfaction and stronger self-control day-to-day but also high stress and lower goal adherence. 
    \end{enumerate}
\end{enumerate}
\subsection{Positive Points}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Duration of the study:} 3 days.
