...
\begin{enumerate}
    ...
    \item Added correct URL for privacy policy in About Us page.
    \item \textbf{Estimated Budget (For 30 days):}
    \begin{enumerate}
        \item 100 rupees per day for daily winner, total = 3000
        \item IITB notebook + pen set for top 3 winner, total = 500*3*4=6000
        \item Monthly winner: 1st rank sports watch : 3000, second rank : IITB Hoodie: 1500, Third - Fifthg rank: Steel bottle and Bag: 3*1000
...
\begin{enumerate}
    ...
    \item Find 21 vulnerability mostly from third party library, link to the report: \href{https://drive.google.com/file/d/1HfIV1nEnnZx0QsAe7Flo7K23HKdTCwdX/view?usp=sharing}{link}
\end{enumerate}
